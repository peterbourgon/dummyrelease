...
retract (
	...
	v2.0.0-20211006000021-5c2ae1d4f8f8 // It was a mistake for this module to move beyond major version 0.
	...
	v2.0.4 // Contains retractions only.
	v2.0.5 // Contains retractions only.
)
